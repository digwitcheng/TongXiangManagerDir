        ...
        public void InitialElc()
        {
            ...
            for (int p = 0; p < gridnum; p++)
            {
                ...
                switch (strType)
                {
                    ...
                    case "充电区":
                        mapnode[tdx, tdy].Type = MapNodeType.chargingArea;
                        break;
                    case "道路":
                        mapnode[tdx, tdy].Type = MapNodeType.Road;
                        break;
                    case "排队区入口":
                        mapnode[tdx, tdy].Type = MapNodeType.queueEntra;
                        try
                        {
                        ...
                        break;
                    case "扫描仪":
                        mapnode[tdx, tdy].Type = MapNodeType.scanner;
                        try
                        {
                        ...
                        break;
                    case "排队区":
                        mapnode[tdx, tdy].Type = MapNodeType.queuingArea;
                        try
                        {
                        ...
                        break;
                    case "休息区":
                        mapnode[tdx, tdy].Type = MapNodeType.restArea;
                        try
                        {
                        ...
                        break;
                    case "工位":
                        mapnode[tdx, tdy].Type = MapNodeType.platform;
                        break;
                    case "障碍区":
                        mapnode[tdx, tdy].Type = MapNodeType.obstacle;
                        break;
                    case "投放口":
                        mapnode[tdx, tdy].Type = MapNodeType.deliveryPort;
                        break;
                    case "禁入点":
                        mapnode[tdx, tdy].Type = MapNodeType.forbidNode;
                        break;
                    default:
